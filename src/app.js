...
const rapidRecallRoutes = require('./routes/rapidRecall.routes');
...
app.use('/api/admin', require('./routes/webUser.routes'));
app.use('/api/admin', require('./routes/adminSubscription.routes'));
